...
export default class CategoryListItem extends Component {
    ...
    getWarningMessage = () => {
        if (this.props.numberOfItemsInStock < 3) {
            return <span className="text-danger font-size-small">The items are about to get out of stock</span>;
        } else {
            return null;
        }
    }
        ...
        if (this.props.numberOfItemsInStock > 0) {
            return (
                ...
                >
                    ...
                    <span className={"badge  rounded-pill " + this.getBadgeClass()}>{this.props.numberOfItemsInStock}</span>
                </li>
            )
        } else {
            return null;
